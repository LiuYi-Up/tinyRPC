...
constexpr makeOrderRequest::makeOrderRequest(
  ...
  : good_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , price_(0){}
...
const uint32_t TableStruct_order_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::makeOrderRequest, good_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::makeOrderResponse, res_code_),
...
const char descriptor_table_protodef_order_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ce\030\001 \001(\005\022\014\n\004good\030\002 \001(\t\"I\n\021makeOrderRespo"
  "nse\022\020\n\010res_code\030\001 \001(\005\022\020\n\010res_info\030\002 \001(\t\022"
  "\020\n\010order_id\030\003 \001(\t2;\n\005Order\0222\n\tmakeOrder\022"
  "\021.makeOrderRequest\032\022.makeOrderResponseB\003"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_order_2eproto = {
  false, false, 211, descriptor_table_protodef_order_2eproto, "order.proto", 
...
makeOrderRequest::makeOrderRequest(const makeOrderRequest& from)
  ...
  good_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    good_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_good().empty()) {
    good_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_good(), 
...
inline void makeOrderRequest::SharedDtor() {
  ...
  good_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          auto str = _internal_mutable_good();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "makeOrderRequest.good"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* makeOrderRequest::_InternalSerialize(
  ...
  // string good = 2;
  if (!this->_internal_good().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_good().data(), static_cast<int>(this->_internal_good().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "makeOrderRequest.good");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_good(), target);
  }
