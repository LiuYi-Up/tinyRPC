...
def generate_project():
    ...
    try:
        ...
        print('=' * 150)
        print("Begin to generate tinyrpc rpc server") 

        generate_dir()  # 生成必要文件夹

        generate_pb()  # 生成 protobuf 文件

        generate_makefile()  # 生成 makefile 文件
        ...
        print("Failed to generate tinyrpc rpc server, err: " + str(e))
        print('=' * 150)
